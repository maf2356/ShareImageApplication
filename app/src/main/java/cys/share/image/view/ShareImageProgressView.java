...
public class ShareImageProgressView extends View {
    ...
    public ShareImageProgressView(Context context) {
        super(context);
        initializePaints(context);
    }

    public ShareImageProgressView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initializePaints(context);
    }

    public ShareImageProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initializePaints(context);
    }
